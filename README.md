...
**١٠ ثيمات فاخرة «كاملة السطح»** فقط (حُذفت الثيمات الـ٣٠ القديمة). قابلة للتبديل من
**حساب المعلّم ← المظهر**؛ يُحفَظ الاختيار محليًا، والافتراضيّ **«عاجيّ دافئ ببرونز»**.

كلّ ثيم يحوّل خلفية التطبيق بالكامل إلى تدرّج غنيّ + **يحيط البطاقات والأزرار والتواريخ
وعناصر الإجراءات بإطارات معدنية** (ذهبي/برونزي/فضّي) مع توهّج ناعم، وتوهّج مؤطَّر متحرّك
عند الضغط. زرّ **تسجيل الخروج** بأحمر أنيق بارز متناسق مع الأسطح. ثلاث فئات:

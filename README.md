...
**١٢ سمة كلاسيكية** قابلة للتبديل من **حساب المعلّم ← المظهر** (قائمة واحدة بسيطة، بلا
فئات)؛ يُحفَظ الاختيار محليًا، والافتراضيّ **«الأساسية»**. كلّها تغيّر الألوان فقط وتدعم
الوضعين الفاتح والداكن، والأزرار والبطاقات بتصميمها الأصلي المسطّح.

| السمة | الطابع |
| --- | --- |
| **الأساسية** | أخضر قرآنيّ + ذهبيّ + خلفية هادئة |
| **سمة الشعار** | قوس ذهبيّ بأشعّة + شريط أخضر + أرضية عاجية |
| **سكينة** | أزرق ليليّ هادئ + لمسة فيروزية |
| **مِحراب** | عنّابيّ تراثيّ + ذهبيّ على أرضية عاجية |
| **الرَّوضة** | أخضر زيتونيّ + رمليّ دافئ |
| **نور** | أحاديّ احترافيّ عالي التباين + لمسة ذهبية |
| **أزرق صافٍ** | رماديّ فاتح ناعم + أزرق هادئ + لمسات خضراء |
| **لوحة الإدارة** | أبيض مائل + بطاقات رمادية + كحليّ ومؤشّرات حالة |
| **فيروز دافئ** | خلفية كريمية + نصّ فحميّ عالي التباين + فيروزيّ |
| **ليل حديث** | فحميّ عميق + نيليّ هادئ + نصّ أبيض ولمسات نيون |
| **كهرمان** | بيج دافئ + بنّيّ عميق + كهرمانيّ برتقاليّ |

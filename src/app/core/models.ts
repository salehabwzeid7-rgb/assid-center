...
/**
 * ترويسة افتراضيّة **لتقارير الفترات** (شهر/أسبوع/مدى) — لا تقول «اليوم».
 * `DEFAULT_REPORT_INTRO` أعلاه مصمَّمة لتقرير جلسة واحدة، فاستعمالها في تقرير
 * شهريّ يُنتج «هذا تقرير حلقة اليوم» فوق بيانات شهر كامل.
 */
export const DEFAULT_PERIOD_REPORT_INTRO =
  'السلام عليكم ورحمة الله وبركاته\nحيّاكم الله أولياء الأمور، هذا تقرير أبنائكم عن الفترة التالية:';
